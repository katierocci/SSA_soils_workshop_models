...
forcing_data_Century <- forcing_data %>%
  ...
  mutate(npp_modis.gC.m2.d = npp_modis*1000/365, #Century units now same as Millennial
         ...
         input_to_metlitter = 0.85 - 0.013 * LN) %>% #percent in AfSIS to fraction in Century
  dplyr::select(SSN_row_ID, Set, forc_st, forc_sw, forc_npp, LN, param_claysilt, Ls, Soil_Organic_Carbon_kg_m2, input_to_metlitter)
