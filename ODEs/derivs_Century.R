...
#Equation B3
  f_TEX = parameters$c1 - parameters$c2*parameters$param_claysilt
...
#Equation B9
  dStrLitter = (1-parameters$input_to_metlitter) * forc_npp(step.num) - f_StrLitter

#Equation B10
  dMetLitter = parameters$input_to_metlitter * forc_npp(step.num) - f_MetLitter
