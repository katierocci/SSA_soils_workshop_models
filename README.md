...
The "parameters" folder has parameters for the default model versions: Millennial (soilpara_in_fit_with_qmax.txt), MIMICS (MIMICS_parameters_sandbox_20231129.R), and Century (soilpara_in_Century.txt), and the fitted model versions: Millennial (soilpara_in_fit_SSA_Millennial), MIMICS (AfSIS_MIMICS_MCMC_Parameterized.csv), and Century (Century_MCMC_out_SingleBest_120325.csv). 
