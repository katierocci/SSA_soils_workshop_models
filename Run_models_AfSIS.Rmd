...
rmse_resid_MIMICS <- sqrt(mean(lm_mimics$residuals^2)) #default=3.68; fitted=3.74
...
RMSE_Mill = sqrt(mean((data_Mill$C_stock_obs_kg_m2 - data_Mill$C_stock_pred_kg_m2)^2)) #default = 7.50; fitted = 4.08
rmse_resid_Mill <- sqrt(mean(lm_millennial$residuals^2)) #default=3.85; fitted=3.55
```
