...
mim5 <- plot_fun_soil_prop(model = "MIMICS", xvar = Naex) +
  scale_x_continuous("exchangeable Na (cmol/kg soil)")

mim6 <- plot_fun_soil_prop(model = "MIMICS", xvar = pH) +
  scale_x_continuous("pH")

mim7 <- plot_fun_soil_prop(model = "MIMICS", xvar = Clay_63um) +
  scale_x_continuous("Clay < 63 um")

mim8 <- plot_fun_soil_prop(model = "MIMICS", xvar = Clay_1_1) +
  scale_x_continuous("1:1 clays (%)")

mim9 <- plot_fun_soil_prop(model = "MIMICS",xvar = Clay_2_1) +
  scale_x_continuous("2:1 clays (%)")

ggpubr::ggarrange(mim1, mim2, mim3, mim4, mim5, mim6, mim7, mim8, mim9)
...
mil5 <- plot_fun_soil_prop(model = "Millennial", xvar = Naex) +
  scale_x_continuous("exchangeable Na (cmol/kg soil)")

mil6 <- plot_fun_soil_prop(model = "Millennial", xvar = pH) +
  scale_x_continuous("pH")

mil7 <- plot_fun_soil_prop(model = "Millennial", xvar = Clay_63um) +
  scale_x_continuous("Clay < 63 um")

mil8 <- plot_fun_soil_prop(model = "Millennial", xvar = Clay_1_1) +
  scale_x_continuous("1:1 clays (%)")

mil9 <- plot_fun_soil_prop(model = "Millennial",xvar = Clay_2_1) +
  scale_x_continuous("2:1 clays (%)")

ggpubr::ggarrange(mil1, mil2, mil3, mil4, mil5, mil6, mil7, mil8, mil9)
